...
Adapted from: https://github.com/libffcv/ffcv-imagenet/blob/main/write_imagenet.py

Example usage:
    # Write the ImageNet train split (max 500px, 50% JPEG, quality 90)
    python write_imagenet.py \
        --cfg.dataset=imagenet \
        --cfg.split=train \
        --cfg.data_dir=/path/to/imagenet/train \
        --cfg.write_path=/your/output/path/train_500_0.5_90.ffcv \
