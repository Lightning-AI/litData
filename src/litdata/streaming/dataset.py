...
class StreamingDataset(IterableDataset):
    ...
    def __init__(
        ...
        Args:
            ...
            s3_session_options: Additional connection options for accessing S3 services.
        ...
        self.s3_session_options = s3_session_options
    ...
    def _create_cache(self, worker_env: _WorkerEnv) -> Cache:
        ...
        cache = Cache(
            ...
            s3_session_options=self.s3_session_options,
